...
import { notifications, unreadNotificationsCount } from "../../data/applications";
                      ...
                      {recentNotifications.map((notif, index) => (
                        <motion.div
                          ...
                          className={`p-4 border-b border-slate-50 dark:border-slate-700/50 hover:bg-slate-50 dark:hover:bg-slate-700/50 cursor-pointer transition-colors ${
                            !notif.read ? "bg-orange-50/30 dark:bg-orange-900/10" : ""
                          }`}
                        >
                ...
                <>
                  ...
                  >
                    <div className="p-4 border-b border-slate-100 dark:border-slate-700">
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400 truncate">{currentStudent.email}</p>
                    </div>
                    <div className="p-2">
                      {[
